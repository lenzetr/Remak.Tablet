...
using Helper = Remak.Tablet.UI.Database.Helper;
...
namespace Remak.Tablet.UI.View
{
    public partial class SplashForm : Form
    {
        ...
        private void SplashForm_Load(object sender, EventArgs e)
        {
            ...
            #region Step 4
            labelStatus.Text = "Bağlantılar Test Ediliyor...";
            labelStatus.Refresh();

            var testIsNetworkAvailable = Global.IsNetworkAvailable;
            var testIsOnline = Global.IsOnline;
